...
class ImapController extends Controller
{
    ...
    private function parse_new_categories($cat)
    {
        $new_cats_map = [
            ...
            "celulares" => "celulares",
            "cámaras fotográficas" => "camaras-fotograficas",
            ...
            "fotografíay video" => "fotografia-y-video",
