    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                ...
                <p>Este sitio web es operado por Bachecubano. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Bachecubano. Bachecubano ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
                ...
                <p>También es posible que, en el futuro, te ofrezcamos nuevos servicios y/o características a través del sitio web (incluyendo el lanzamiento de nuevas herramientas y recursos). Estas nuevas caraterísticas y/o servicios tambien estarán sujetos a estos Términos de Servicio.</p>
                ...
                <p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de General Lee 253 entre Juan Delgado y Destrampes, 10 de octubre, 02, , Cuba.</p>
                ...
                <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a contacto@bachecubano.com.</p>
            </div>
